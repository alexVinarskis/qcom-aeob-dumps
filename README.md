...
1. Obtain `AeoBUtils` tool, either download pre-compiled binary from [releases page in this repo](https://github.com/alexVinarskis/qcom-aeob-dumps/releases/latest), or compile from [source](https://github.com/WOA-Project/AeoBUtils). If you want to compile it yourself, these steps might be instructional:
